...
public class DeploymentRestCall {
    ...
    public static DeploymentDto DeploymentBPMNToWorkspace(String type, String data) {
        ...
        String body = res.executeWithPostData("/engine-rest/deployment/create", type, data);
        if (body == null) {
            return null;
        }
        Gson json = new Gson();
    ...
    public static DeploymentDto getDeploymentByID(String deploymentID) {
        ...
        try {
            String body = res.execute("/engine-rest/deployment/" + deploymentID);
            Gson json = new Gson();
    ...
    public static List<DeploymentResourceDto> GetResourceByDeploymentByID(String deploymentID) {
        ...
        try {
            String body = res.execute("/engine-rest/deployment/" + deploymentID + "/resources");
            Gson json = new Gson();
    ...
    public static ActionRespone DeleteDeployment(String deploymentID) {
        RestEnginerCall res = RestEnginerCurrentService.getRestEngineCurrent();
        res.execute("/engine-rest/deployment/" + deploymentID + "?cascade=true&skipCustomListeners=true&skipIoMappings=true", HttpMethod.DELETE);
